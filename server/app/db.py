...
DATABASE_PATH = DATABASE_DIR / "smart_erp.db"
...
def initialize_database_schema():
    ...
    try:
        ...
        # Insert default ERP datasource if not exists
        cursor.execute('''
            INSERT OR IGNORE INTO datasources (id, name, description, type, is_active, file_count)
            VALUES (1, 'Default ERP', 'Default ERP system data (products, inventory, sales)', 'default', 1, 0)
        ''')

  ...
  const features = [
    {
      icon: FaBrain,
      title: '智能问答',
      description: '使用自然语言查询ERP数据，如"本月销售额多少？"',
      color: 'primary',
      status: '可用'
    },
    {
    ...
    <div>
      ...
      <Alert variant="info" className="mb-4">
        ...
        <p className="mb-0">
          ...
          基于 <strong>LangChain + ERP数据 + FastAPI + React</strong> 构建的演示项目
        </p>
      </Alert>
          ...
          <Card className="border-primary">
            <Card.Body className="text-center">
              ...
              <p className="text-muted mb-0">
                这是一个基于产品方案构建的SmartERP AI Assistant前端演示项目。

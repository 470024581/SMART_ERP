...
class Config:
    ...
    # 数据库配置
    DATABASE_URL: str = os.getenv("DATABASE_URL", f"sqlite:///{DATA_DIR}/smart_erp.db")
    DATABASE_PATH: Path = DATA_DIR / "smart_erp.db"
    ...
    API_TITLE: str = "SmartERP AI Assistant API"
    API_DESCRIPTION: str = "API for interacting with the SmartERP AI Assistant, powered by LangChain and FastAPI."
